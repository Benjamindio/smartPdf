    ...
    <header className='absolute inset-x-0 top-0 z-50'>
      <nav className='flex lg:flex-1 items-center justify-between p-6 lg:px-8' >
        ...
        {isAuth ? (<UserButton afterSignOutUrl='/'/>) :( <a
                href="/sign-in"
                className=" flex items-center gap-2 rounded-md bg-[#5271FF] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
        ...
        <div className="max-w-2xl py-32 lg:py-44 w-2/5">
          ...
          <div className="">
            ...
            <div className="mt-10 flex items-center  gap-x-6">
              ...
              {isAuth ? (<h1>fileUpload</h1>) :(<a href="" className="text-sm font-semibold leading-6 text-gray-900">
